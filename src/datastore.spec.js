  ...
  describe('factory', () => {
    ...
    describe('#read', () => {
      it('Should fetch a record', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse1);
      ...
      it('Should fail because the record does not exist', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse2);
      ...
      it('Should fail because of an unexpected error', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    describe('#create', () => {
      ...
      it('Should create a record', async () => {
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.OK, ['1234']);
      ...
      it('Should fail because of an unexpected error', async () => {
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.INTERNAL_SERVER_ERROR);
      ...
      it('Should succeed after retries on conflict', async () => {
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.CONFLICT)
          .post(/.*/u).reply(HttpStatus.OK, ['1234']);
      ...
      it('Should fail after retries on conflict', async () => {
        nock('https://api')
          ...
          .post(/.*/u).reply(HttpStatus.CONFLICT)
          .post(/.*/u).reply(HttpStatus.CONFLICT)
          .post(/.*/u).reply(HttpStatus.OK, ['foo']);
        ...
        try {
          ...
          expect(err).to.be.an('error');
          expect(err.message).to.match(/^Unexpected response: 409/u);
          return;
        }
      ...
      it('Should fail during service offline hours', async () => {
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.SERVICE_UNAVAILABLE);
    ...
    describe('#update', () => {
      ...
      it('Should update a record', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse3);
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.OK, ['1234']);
      ...
      it('Should fail because the record does not exist', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse4);
      ...
      it('Should fail because target record has changed in datastore', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse5);
      ...
      it('Should fail during service offline hours', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse6);
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.SERVICE_UNAVAILABLE);
      ...
      it('Should update a record with the specified indexing priority', async () => {
        ...
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse7);
        nock(recordLoadURL)
      ...
      it('Should update a record and replace "WRONG" id to given id', async () => {
        nock('https://sru/bib')
          .get(/.*/u).reply(HttpStatus.OK, sruResponse8);
        nock('https://api')
          .post(/.*/u).reply(HttpStatus.OK, ['4321']);
